...
$mod_strings = array(
	...
	'LBL_IMPORT_STEP_3'=>'Стъпка 3',
	'LBL_IMPORT_STEP_4'=>'Step 4',
	'LBL_IMPORT_STEP_1_DESCRIPTION'=>'Изберете файл',
	'LBL_IMPORT_STEP_2_DESCRIPTION'=>'Избери формат',
	...
	'LBL_SELECT_MERGE_FIELDS'=>'Изберете съвпадащите полета, за да намерите дублиращите се записи',
	...
	'LBL_NUMBER_OF_RECORDS_CREATED'=>'Брой създадени записи',
	...
	'ERR_UNIMPORTED_RECORDS_IN_QUEUE'=>'Потребителят все още има неимпортирани записи на опашка',
	...
	'TOTAL_RECORDS'=>'Общ брой записи',
	'LBL_NUMBER_OF_RECORDS_DELETED'=>'Брой изтрити записи',
	'LBL_NUMBER_OF_RECORDS_MERGED'=>'Number of records merged',
	'LBL_TOTAL_RECORDS'=>'Total Number of Records',
	'LBL_UNDO_RESULT'=>'Отмяна на резултата за импортиране',
	'LBL_LAST_IMPORTED_RECORDS'=>'Last Imported Records',
	'LBL_NO_ROWS_FOUND'=>'Няма открити редове',
	...
	'ERR_FAILED_TO_LOCK_MODULE'=>'Неуспешно заключване на модула за импортиране. Моля, опитайте отново по-късно.',
	'LBL_RUNNING'=>'Running',
	'LBL_CLEAR_DATA'=>'Изчистване на данните',
	'ERR_MODULE_IMPORT_LOCKED'=>'Импортирането не може да бъде изпълнено, друг импорт е в ход. Опитайте по-късно.',
	'LBL_MODULE_NAME'=>'Модул',
	'LBL_USER_NAME'=>'Потребител',
	'LBL_LOCKED_TIME'=>'Locked Time',
	'LBL_CANCEL_IMPORT'=>'Отмяна на импортирането',
	'ERR_IMPORT_INTERRUPTED'=>'Импортирането е спряно. Моля, опитайте отново по-късно.',
