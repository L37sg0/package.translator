...
$mod_strings = Array(
'LBL_MIGRATE_INFO'=>'Въведете стойности за миграция на данни <b><i> Източник </i></b> до <b><i> Текущ (Последен) vtigerCRM </i></b>',
'LBL_CURRENT_VT_MYSQL_EXIST'=>'Настоящ vtiger\ MySQL съществува в',
...
'LBL_NOTES_LIST2'=>'Ако настоящият MySQL съществува в друга машина, тогава въведете името на файла (източник)за зареждане на пълния път.',
...
'LBL_NOTES_LIST3'=>'Дайте MySQL път като <b>/home/crm/vtigerCRM4_5/mysql</b>',
'LBL_NOTES_LIST4'=>'Give the Dump filename with full Path like <b>/home/fullpath/4_2_dump.txt</b>',

'LBL_CURRENT_MYSQL_PATH_FOUND'=>'Текущата инсталаиця\'s MySQL път е намерен.',
'LBL_SOURCE_HOST_NAME'=>'Source Host Name :',
'LBL_SOURCE_MYSQL_PORT_NO'=>'Източникна порт на MySql :',
'LBL_SOURCE_MYSQL_USER_NAME'=>'Източник MySql потребителско име :',
'LBL_SOURCE_MYSQL_PASSWORD'=>'Източник MySql Парола :',
'LBL_SOURCE_DB_NAME'=>'Име на БД- източник :',
'LBL_MIGRATE'=>'Migrate to Current Version',
//Added after 5 Beta 
'LBL_UPGRADE_VTIGER'=>'Upgrade vtiger CRM Database',
'LBL_UPGRADE_FROM_VTIGER_423'=>'Обновяване на база данни от vtiger CRM 4.2.3 to 5.0.0',
...
'LBL_RADIO_BUTTON2_DESC'=>'Тази опция изисква изхвърляне на база данни на локално ниво в същата машина, на която надграждате. Не можете да получите достъп до изхвърляне на данни от друга машина (отдалечен сървър на база данни). Вижте документацията за Помощ.',
'LBL_RADIO_BUTTON3_TEXT'=>'Имам нова база данни с 4.2.3 данни',
...
'LBL_MYSQL_PASSWORD'=>'MySql парола : ',
...
'LBL_ENTER_MYSQL_SERVER_PATH'=>'Виведете пътя на MySQL сървъра',
...
'LBL_UPGRADE_FROM_VTIGER_5X'=>'Надгрждане на база данни от vtiger CRM 5.x към следваща версия',
'LBL_PATCH_OR_MIGRATION'=>'трябва да посочте версията на базата данни (Актуализация на Patch или миграция)',
