...
$mod_strings = array(
	...
	'LBL_MORPHSUIT_DESCRIPTION'=>'Send to <b>%s</b> the activation key.',
	'LBL_MORPHSUIT_KEY_EMPTY'=>'The key is empty.',
	'LBL_MORPHSUIT_CODE'=>'Поставете тук кода за активиране',
	'LBL_MORPHSUIT_CODE_EMPTY'=>'Активационния код е празен.',
	'LBL_MORPHSUIT_CODE_RIGHT'=>'Кодът за активиране е правилен!\nКликнете OK за да продължите.',
	'LBL_MORPHSUIT_CODE_WRONG'=>'Invalid activation key',
	'LBL_MORPHSUIT_CODE_WRONG_TIME_EXPIRED'=>'Остарял ключ за активиране',
	'LBL_MORPHSUIT_ACTIVATION_MAIL_ERROR'=>'I was unable to send the request, please send an email with the activation key',
	'LBL_MORPHSUIT_ACTIVATION_MAIL_OK'=>'Съобщението беше изпратено до мрежата на VTECRM, проверете входящата си поща за активационен ключ.',
	...
	'LBL_MORPHSUIT_USER_NUMBER_UNLIMITED'=>'Неограничено',
	...
	'LBL_AVAILABLE_VERSION_UPDATE'=>'Обнови сега',
	'LBL_ERROR_VTE_REGISTRATION'=>'You have to sign up to www.crmvillage.biz',
	'LBL_ERROR_SMTP'=>'Все още не сте настроили изходящ мейл сървър (SMTP). Той е необходим за функцията за възстановяване на парола. Искате ли да го направите сега?',
	...
	'LBL_MORPHSUIT_ROLE_NUMBER_EXCEEDED'=>'Превишили сте броя на ролите, налични в БЕЗПЛАТНАТА версия.',
	...
	'LBL_MORPHSUIT_ADV_SHARING_RULE_NUMBER_EXCEEDED'=>'Превишихте броя на усъвършенстваните правила за споделяне, налични в Безплатната версия.',
	...
	'LBL_ERROR_VTE_FREE_NOT_ACTIVABLE'=>'Тази версия е невалидна. Моля инсталирайте по- нова.',
	...
	'LBL_MORPHSUIT_OVERWRITE_CREDENTIALS'=>'Поверителните данни на администратора ще бъдат заменени от поверителните данни на '.$enterprise_website[1].'.',
	'LBL_MORPHSUIT_BUSINESS_ACTIVATION'=>'You have to activate a Business On Site version.',
	'LBL_MORPHSUIT_REGISTER'=>'Регистрация',
